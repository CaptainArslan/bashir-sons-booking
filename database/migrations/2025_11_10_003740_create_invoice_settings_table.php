...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('invoice_settings', function (Blueprint $table) {
            ...
            $table->string('size')->nullable(); // A4, 58mm, 80mm
            ...
            $table->boolean('is_default')->default(false); // 0=not default, 1=default
            $table->boolean('status')->default(false);
            $table->string('invoice_date_format')->default('Y-M-d h:m:s');
            $table->longText('show_column')->nullable(); // JSON
            $table->longText('extra')->nullable(); // JSON
