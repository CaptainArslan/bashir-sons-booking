...
class UpdateRouteTimetableRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()->can('edit route timetables');
    }
    ...
    {
        $timetableId = $this->route('routeTimetable')->id ?? null;

        return [
            'route_id' => 'required|exists:routes,id',
            'trip_code' => 'required|string|max:255|unique:route_timetables,trip_code,' . $timetableId,
