...
class StoreRouteTimetableRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()->can('create route timetables');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'trip_code' => 'required|string|max:255|unique:route_timetables,trip_code',
