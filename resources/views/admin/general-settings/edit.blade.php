                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('phone') is-invalid @enderror" 
                                            id="phone" name="phone" 
                                            placeholder="Enter Phone" value="{{ old('phone', $settings->phone) }}" required>
                                    </div>
                                    @error('phone')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('alternate_phone') is-invalid @enderror" 
                                            ...
                                            placeholder="Enter Alternate Phone" value="{{ old('alternate_phone', $settings->alternate_phone) }}">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('support_phone') is-invalid @enderror" 
                                            ...
                                            placeholder="Enter Support Phone" value="{{ old('support_phone', $settings->support_phone) }}">
                                    </div>
                                    @error('support_phone')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
