        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Edit Discount</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Edit Discount Information</h4>
                    </div>
                    <div class="card-body">
                        @if(session('success'))
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('discount_type') is-invalid @enderror" 
                                            ...
                                            <option value="fixed" {{ old('discount_type', $discount->discount_type) == 'fixed' ? 'selected' : '' }}>Flat Amount</option>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">
                                            ...
                                            Check this box to make the discount active.
                                        </div>
                                    </div>
                                </div>
                            </div>
