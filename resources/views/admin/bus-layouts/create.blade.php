                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <button type="button" class="btn btn-outline-primary btn-sm" id="generate-seat-map">
                                        <i class="bx bx-refresh me-1"></i>Generate Seat Map
                                    </button>
                                </div>
                                
                                <div class="alert alert-info" id="seat-map-info" style="display: none;">
                                    <i class="bx bx-info-circle me-1"></i>
                                    <strong>Seat Map Generated!</strong> You can now customize individual seat properties by clicking on them.
                                </div>
                                
                                <div id="seat-map-container" class="seat-map-container">
                                    <div class="text-center text-muted py-4">
                                        <i class="bx bx-chair" style="font-size: 3rem;"></i>
                                        <p class="mt-2">Enter rows and columns above, then click "Generate Seat Map" to create the seat layout.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
