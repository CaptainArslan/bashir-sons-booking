        ...
        <div class="col-xl-10 mx-auto">
            <div class="card schedule-card">
                <div class="card-header-info">
                    <h5><i class="bx bx-plus-circle me-2"></i>Create New Schedule</h5>
                </div>
                ...
                <form method="POST" action="{{ route('admin.schedules.store') }}">
                    ...
                    <div class="card-body">
                        <!-- Info Box -->
                        <div class="info-box">
                            <p><i class="bx bx-info-circle me-1"></i><strong>Tip:</strong> Create a schedule to define when buses operate on a specific route. Set departure/arrival times and operating frequency.</p>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-text">Set schedule as active or inactive</div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer bg-light">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                <a href="{{ route('admin.schedules.index') }}" class="btn btn-secondary px-4">
