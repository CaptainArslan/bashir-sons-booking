        ...
        <div class="col-xl-10 mx-auto">
            <div class="card schedule-card">
                <div class="card-header-info">
                    <h5><i class="bx bx-edit me-2"></i>Edit Schedule: {{ $schedule->trip_code }}</h5>
                </div>
                ...
                <form method="POST" action="{{ route('admin.schedules.update', $schedule) }}">
                    ...
                    <div class="card-body">
                        <!-- Info Box -->
                        <div class="info-box">
                            <p><i class="bx bx-info-circle me-1"></i><strong>Tip:</strong> Update the schedule details below. Changes will affect all future bookings using this schedule.</p>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('trip_code', $schedule->trip_code) }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="frequency" 
                                    ...
                                    @foreach($frequencyTypes as $frequency)
                                        <option value="{{ $frequency->value }}" {{ old('frequency', $schedule->frequency->value) == $frequency->value ? 'selected' : '' }}>
                                            {{ $frequency->getName() }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="operating-days-section" id="operating-days-section" style="display: none;">
                            ...
                            <div class="row">
                                @php
                                    ...
                                    $selectedDays = old('operating_days', $schedule->operating_days ?? []);
                                @endphp
                                @foreach($days as $day)
                    ...
                    <div class="card-footer bg-light">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <a href="{{ route('admin.schedules.show', $schedule) }}" class="btn btn-light px-4">
