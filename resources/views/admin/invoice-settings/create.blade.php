...
@section('title', 'Create Invoice Setting')
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <p class="text-muted mb-0 mt-1">Configure invoice template settings for ticket printing</p>
                        </div>
                ...
                <div class="form-section basic">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="invoice_name" value="{{ old('invoice_name') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="file_type">
                                ...
                                @foreach($fileTypes as $type)
                                    <option value="{{ $type }}" {{ old('file_type') == $type ? 'selected' : '' }}>{{ strtoupper($type) }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="color-picker-wrapper">
                                <input type="color" class="form-control form-control-color" name="primary_color" 
                                       value="{{ old('primary_color', '#0d6efd') }}" id="primaryColor">
                                <input type="text" class="form-control" id="primaryColorText" 
                                       value="{{ old('primary_color', '#0d6efd') }}" placeholder="#000000">
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="color-picker-wrapper">
                                <input type="color" class="form-control form-control-color" name="secondary_color" 
                                       value="{{ old('secondary_color', '#6c757d') }}" id="secondaryColor">
                                <input type="text" class="form-control" id="secondaryColorText" 
                                       value="{{ old('secondary_color', '#6c757d') }}" placeholder="#000000">
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="color-picker-wrapper">
                                <input type="color" class="form-control form-control-color" name="text_color" 
                                       value="{{ old('text_color', '#212529') }}" id="textColor">
                                <input type="text" class="form-control" id="textColorText" 
                                       value="{{ old('text_color', '#212529') }}" placeholder="#000000">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Company Logo</label>
                            <input type="file" class="form-control" name="company_logo" accept="image/*" onchange="previewImage(this, 'companyLogoPreview')">
                            <div class="preview-container" id="companyLogoPreview"></div>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label class="form-label">Logo Width</label>
                            <input type="text" class="form-control" name="logo_width" value="{{ old('logo_width') }}" placeholder="e.g., 100px">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label class="form-label">Logo Height</label>
                            <input type="text" class="form-control" name="logo_height" value="{{ old('logo_height') }}" placeholder="e.g., 50px">
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="preview-container" id="invoiceLogoPreview"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section numbering">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="prefix" value="{{ old('prefix') }}" placeholder="e.g., INV">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Number of Digits</label>
                            <input type="text" class="form-control" name="number_of_digit" value="{{ old('number_of_digit') }}" placeholder="e.g., 6">
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" name="numbering_type">
                                ...
                                @foreach($numberingTypes as $type)
                                    <option value="{{ $type }}" {{ old('numbering_type') == $type ? 'selected' : '' }}>{{ ucfirst($type) }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Start Number</label>
                            <input type="number" class="form-control" name="start_number" value="{{ old('start_number', 1) }}" min="1">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Last Invoice Number</label>
                            <input type="number" class="form-control" name="last_invoice_number" value="{{ old('last_invoice_number', 0) }}" min="0">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="footer_title" value="{{ old('footer_title') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Header Text</label>
                            <textarea class="form-control" name="header_text" rows="4">{{ old('header_text') }}</textarea>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Footer Text</label>
                            <textarea class="form-control" name="footer_text" rows="4">{{ old('footer_text') }}</textarea>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="invoice_date_format" 
                                   value="{{ old('invoice_date_format', 'Y-M-d h:m:s') }}" required>
                ...
                <div class="row">
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary">
                            <i class="bx bx-save me-2"></i>Create Invoice Setting
                        </button>
