    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">
                <i class="bx bx-plus me-2"></i>Create New Fare
            </h1>
            <p class="text-muted mb-0">Add a new fare between terminals</p>
        </div>
    ...
    <div class="card shadow">
        <form action="{{ route('admin.fares.store') }}" method="POST" id="fare-form">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="form-control-plaintext bg-light p-3 rounded">
                            <span class="fw-bold text-success" id="final-fare-display">PKR 0.00</span>
                ...
                <!-- Route Preview -->
                <div class="row" id="route-preview" style="display: none;">
                    <div class="col-12">
...
function resetForm() {
    if (confirm('Are you sure you want to reset the form? All entered data will be lost.')) {
        ...
        $('#final-fare-display').text('PKR 0.00');
        $('#route-preview').hide();
        calculateFinalFare();
    }
}
