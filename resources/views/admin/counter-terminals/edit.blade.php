...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-10 mx-auto">
            <form action="{{ route('admin.counter-terminals.update', $terminal->id) }}" method="POST" class="row g-3">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4">Edit Terminal</h5>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                    name="name" placeholder="Enter Terminal Name" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror" id="code"
                                    name="code" placeholder="Enter Terminal Code (e.g., KAR01)" 
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" id="address"
                                    name="address" rows="3" placeholder="Enter Terminal Address" required>{{ old('address', $terminal->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
