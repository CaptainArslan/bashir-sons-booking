    ...
    <div class="row">
        <div class="col-xl-8 mx-auto">
            <div class="card terminal-card">
                ...
                <form action="{{ route('admin.counter-terminals.update', $terminal->id) }}" method="POST" id="terminal-form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-body">
                        <!-- Info Box -->
                        <div class="info-box">
                            <p><i class="bx bx-info-circle me-1"></i><strong>Tip:</strong> Update terminal information as needed. Changes will be saved immediately when you submit the form.</p>
                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">
                                            <span class="badge {{ $terminal->status->value === 'active' ? 'bg-success' : 'bg-secondary' }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" 
                                          ...
                                          required>{{ old('address', $terminal->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
