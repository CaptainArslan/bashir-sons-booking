...
@section('content')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Create Route Stop</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xl-10 mx-auto">
            <form action="{{ route('admin.route-stops.store') }}" method="POST" class="row g-3">
                @csrf
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4">Create Route Stop</h5>
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('sequence') is-invalid @enderror" id="sequence"
                                    name="sequence" placeholder="Enter sequence number" value="{{ old('sequence') }}" min="1" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('distance_from_previous') is-invalid @enderror" id="distance_from_previous"
                                    name="distance_from_previous" placeholder="Enter distance in kilometers" value="{{ old('distance_from_previous') }}" 
                                    step="0.1" min="0">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('approx_travel_time') is-invalid @enderror" id="approx_travel_time"
                                    name="approx_travel_time" placeholder="Enter travel time in minutes" value="{{ old('approx_travel_time') }}" 
                                    min="0">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_dropoff_allowed" name="is_dropoff_allowed" value="1" 
                                        {{ old('is_dropoff_allowed') ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary px-4">
                                        <i class="bx bx-save me-1"></i>Create Route Stop
                                    </button>
                                </div>
                            </div>
                        </div>
